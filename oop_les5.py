# class haykakan:
# 	def __init__(self,xorovac,qyabab):
# 		self.xorovac = xorovac
# 		self.qyabab = qyabab 
# 	def presentation(self):
# 		print(F"We have in Armenian kitchen \n {self.xorovac}\n {self.qyabab}")



# class vracakan:
# 	def __init__(self,ajarakan,xinkali):
# 		self.ajarakan = ajarakan
# 		self.xinkali = xinkali
# 	def presentation_vrac(self):
# 		print(F"We have in George kitchen \n {self.ajarakan}\n {self.xinkali}")	




# class mixed_(haykakan,vracakan):
# 	def __init__(self,xorovac,qyabab,ajarakan,xinkali):
# 		haykakan.__init__(self,xorovac,qyabab)
# 		vracakan.__init__(self,ajarakan,xinkali)
# 	def mixed_presentation(self):
# 		self.presentation()
# 		self.presentation_vrac()		



# mixed_menu= mixed_("Xorovac","Qyabab","Ajarakan","Xinkali")
